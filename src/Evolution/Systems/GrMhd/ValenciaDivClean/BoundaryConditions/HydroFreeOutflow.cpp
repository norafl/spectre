...
std::optional<std::string> HydroFreeOutflow::dg_ghost(
  ...
  ComputeFluxes::apply(tilde_b_flux, tilde_d_flux, tilde_ye_flux,
                       tilde_tau_flux, tilde_s_flux, tilde_phi_flux, *tilde_b,
                       *tilde_d, *tilde_ye, *tilde_tau, *tilde_s, *tilde_phi,
